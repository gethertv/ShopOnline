...
class ShoppingListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_list" do
    assert_difference("ShoppingList.count") do
      post shopping_lists_url, params: { shopping_list: { date: @shopping_list.date, gross_price: @shopping_list.gross_price, net_price: @shopping_list.net_price, product_id: @shopping_list.product_id, quantity: @shopping_list.quantity } }
    end
  ...
  test "should update shopping_list" do
    patch shopping_list_url(@shopping_list), params: { shopping_list: { date: @shopping_list.date, gross_price: @shopping_list.gross_price, net_price: @shopping_list.net_price, product_id: @shopping_list.product_id, quantity: @shopping_list.quantity } }
